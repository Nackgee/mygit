		...
		<span> <- Go Back</span></button>
  		<form id="authForm2" class="hidden" method="POST">
                ...
                <div class="category_box">
                    ...
                    <div class="box_2 lastttt">
                        <input type="text" name="email" placeholder="メールを入力してください。"
                        		value="${userModel.email }" required>
                    </div>
                </div>
            </div>
            ...
            <div class="info">
                <div class="category_box">
                    <div class="box_1">
                        <span>性別　(現代:${userModel.gender })</span>
                    </div>
                    <div class="box_2">
            ...
            <div class="info">
                <div class="category_box">
                    ...
                    <div class="box_2">
                        <input type="date" name="birthday" value="${userModel.birthday }" min="1960-01-01" max="2010-01-01" required>
                    </div>
                </div>
            </div>
            ...
            <div class="info" style="height: 100px;">
                <div class="category_box">
                    ...
                    <div class="box_2" style="padding: 8px 0; width: 545px;">
                        <input type="text" id="telx"  name="phone_num" style="font-size: 15px; color:black" placeholder="電話番号を入力"
                        		value="${userModel.phone_num }" required><br><br>
