...
<body>
    ...
    <main class="wrap">
		...
		<c:forEach var="hotel" items="${hotelList }" >
	    	...
	    	<div class="menu">
	            <div class="menu">
	                <img class="menu" src="resources/img/<c:out value="${hotel.image_path }" />.webp" alt width="300.8" height="285.75">
	                <div class="찜">♥</div>
	                <div class="itemName">
	                    <div><c:out value="${hotel.name }" /></div>
	                    <div> 4.75 ★</div>
	                </div>
	                <div class="sub">150km 距離</div>
	                <div class="sub">8月 15日～21日</div>
	                <div class="price"> \39900円 / 泊</div>
	                <ul><br><br></ul>
	            </div>
        	</div>
