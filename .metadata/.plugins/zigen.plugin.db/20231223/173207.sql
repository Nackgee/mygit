...
INSERT INTO hotel (name, address, phone_num, hotel_cat, originalfile1, savedfile1, short_com1, short_com2) 
VALUES ('三井寺　風鈴トンネル', '福岡県田川市', '0947-42-7206', 'SNOw', '3', '3', 'ユニークなお地蔵さまと1万個の風鈴が迎えてくれる風鈴寺', '八方ふさがりの人千手観世音菩薩などもあります');
...
INSERT INTO hotel (name, address, phone_num, hotel_cat, originalfile1, savedfile1, short_com1, short_com2) 
VALUES ('太原のイチョウ', '福岡県糟屋郡', '0943-32-5555', 'SIMA', '5', '5', '黄金色に染まるシンボルツリー・イチョウの並木', '町制施行30周年を記念して公募、町の木として制定されました');
