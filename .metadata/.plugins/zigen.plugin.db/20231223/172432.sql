...
INSERT INTO hotel (name, address, phone_num, hotel_cat, originalfile1, savedfile1, short_com1, short_com2) 
VALUES ('三井寺　風鈴トンネル', '福岡県田川市伊田2706-1', '0947-42-7206', 'KAN', '3', '3', 'ユニークなお地蔵さまと1万個の風鈴が迎えてくれる風鈴寺', '個性豊かな八本地蔵、八方ふさがりの人千手観世音菩薩などもあります');

INSERT INTO hotel (name, address, phone_num, hotel_cat, originalfile1, savedfile1, short_com1, short_com2) 
VALUES ('南蔵院', '福岡県糟屋郡篠栗町大字篠栗1035', '092-947-7195', 'KAN', '4', '4', '世界最大級のブロンズ製釈迦涅槃像は圧巻！', '今では日本三大新四国霊場のひとつに数えられています.');


INSERT INTO hotel (name, address, phone_num, hotel_cat, originalfile1, savedfile1, short_com1, short_com2) 
VALUES ('太原のイチョウ', '福岡県糟屋郡篠栗町大字篠栗1035', '0943-32-5555', 'BEACH', '5', '5', '黄金色に染まるシンボルツリー・イチョウの並木', '町制施行30周年を記念して公募、町の木として制定されました.');
